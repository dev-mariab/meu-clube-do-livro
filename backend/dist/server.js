...
// User profile routes
app.get(`${apiPrefix}/me`, authMiddleware, (req, res) => AuthController.getMe(req, res));
app.put(`${apiPrefix}/me`, authMiddleware, (req, res) => AuthController.updateProfile(req, res));
